...
@Data
@Document(indexName = "", type = "channelprice", shards = 5, replicas = 1, refreshInterval = "1s", versionType = VersionType.EXTERNAL)
public class ChannelPrice2Vo extends BaseVo {
